...
const Block: React.FC<BlockProps> = ({ title, value, link = null, copy = false }) => {
  ...
  return (
    <div className="core-black-contrast rounded relative overflow-hidden">
      <div className="text-white p-4">{title}</div>
