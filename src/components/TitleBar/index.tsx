  ...
  return (
    <div className="backdrop-blur-md bg-black/40 p-4 z-40">
      ...
      <div className="grid grid-cols-12 h-full">
        ...
        <div className="svg col-span-9">
          <div className="absolute top-0 right-2 flex h-full items-center justify-end gap-2">
            {statusInfo && statusInfo.locked === false && (
              <div className="flex items-center bg-status-red rounded-full px-3 py-1 text-sm font-bold text-black">
                <div className="mr-2">Node unlocked</div>
