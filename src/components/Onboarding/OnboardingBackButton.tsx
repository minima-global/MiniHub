...
const BACKWARD_STEPS: Record<string | number, string | number> = {
    ...
    [STEPS.FRESH_NODE_LOADING_FOR_KEYS]: STEPS.FRESH_NODE_SETUP,
    [STEPS.FRESH_NODE_SKIP_PEERS]: STEPS.FRESH_NODE_CONNECT_OPTIONS,
    [STEPS.FRESH_NODE_SET_NAME]: STEPS.FRESH_NODE_LOADING_FOR_KEYS,
...
const OnboardingBackButton = ({ onClick }: { onClick?: () => void }) => {
    ...
    const showBackButton = useMemo(() => {
        const backButtonSteps = [
            ...
            STEPS.FRESH_NODE_SKIP_PEERS,
            STEPS.FRESH_NODE_SET_NAME,
            STEPS.FRESH_NODE_LOADING_FOR_KEYS,
