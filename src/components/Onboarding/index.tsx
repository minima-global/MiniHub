                    ...
                    <div className="relative z-30">
                        ...
                        <OnboardingWrapper display={step === 1}>
                            <OnboardingModal display={step === 1}>
                                <h1 className="-mt-1.5 mb-8 text-2xl text-center mx-auto">Let's get started</h1>
                                <div className="flex flex-row gap-3">
                                    <div onClick={goToFreshNodeSetup} className="bg-contrast-1 hover:bg-contrast-1.5 active:scale-[98%] text-center transition-all duration-100 cursor-pointer p-9 rounded">
                                        <img src="./icons/create_a_new_account.svg" alt="Create a new account" className="w-10 h-10 mx-auto mb-4" />
                                        Create a new account
                                    </div>
                                    <div onClick={goToSeedPhraseOptions} className="bg-contrast-1 hover:bg-contrast-1.5 active:scale-[98%] text-center transition-all duration-100 cursor-pointer p-9 rounded">
                                        <img src="./icons/restore_from_phrase.svg" alt="Create a new account" className="w-10 h-10 mx-auto mb-4" />
                                        Import a seed phrase
                                    </div>
                                    <div onClick={goToRestoreFromBackup} className="bg-contrast-1 hover:bg-contrast-1.5 active:scale-[98%] text-center transition-all duration-100 cursor-pointer p-9 rounded">
