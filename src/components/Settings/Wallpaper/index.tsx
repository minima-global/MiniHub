...
export function Wallpaper({ display, dismiss }: any) {
  ...
  return (
    <SlideScreen display={display}>
      ...
      <div className="flex flex-col h-full mt-8 bg-black">
        <div className="pt-10 px-6 pb-14 flex flex-col h-full overflow-auto custom-scrollbar">
          ...
          <div className="mt-6 text-2xl mb-6">Wallpaper</div>
