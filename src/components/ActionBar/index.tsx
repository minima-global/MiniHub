...
const ActionBar = () => {
  const { setShowInstall, query, setQuery } = useContext(appContext);
  ...
  return (
    <div className="relative w-full max-w-[98%] lg:max-w-5xl mx-auto mt-6 mb-3 lg:mt-10 lg:mb-5 px-5 lg:px-0">
      {showSearch && (
        <div className="absolute flex w-full top-0 bottom-0 z-10 text-center">
